...
import 'package:crypto_mvp_flutter/about.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  final List<Color> _colors = [Colors.pink, Colors.lightBlue, Colors.redAccent, Colors.purple, Colors.green];
  List data;
...
Widget getListItemUi(Map currency, Color color) {
  return ListTile(
    ...
    subtitle: _getSubtitle(currency["price_usd"], currency["percent_change_24h"]),
    isThreeLine: true,
  );
}
...
Widget _getSubtitle(String priceUsd, String percentageChange) {
  ...
  if(double.parse(percentageChange) > 0) {
    percentChangeTextWidget = TextSpan(text: percentageChangeText,
